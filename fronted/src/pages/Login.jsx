// src/components/FoodLoginPage.jsx
import { useState } from "react";
// import { FaUtensils, FaEnvelope, FaLock } from "react-icons/fa";
import SignupPage from "./SignupPage";
export default function Login({handleSignupLogin}) {
...
{
show &&<div className="fixed top-19 right-4 bg-green-600 text-white px-7 py-4 rounded-lg shadow-lg flex items-center justify-between w-100 
      animate-[pop_0.9s_ease-out]">
        <span style={{textAlign:"left"}}>✅ {status}</span>
        <button onClick={() => setShow(false)} className="ml-3 text-white font-bold">
          ✖
        </button>
    ...
    <div className="h-screen w-full flex items-center justify-center bg-cover bg-center" 
      ...
      <div className="bg-white/90 backdrop-blur-xl p-8 rounded-3xl shadow-2xl w-full max-w-md">
        ...
        <div className="flex items-center justify-center mb-6">
          {/* <FaUtensils className="text-orange-600 text-4xl mr-2" /> */}
          <h1 className="text-3xl font-extrabold text-orange-600">Foodie Login </h1>
        </div>
