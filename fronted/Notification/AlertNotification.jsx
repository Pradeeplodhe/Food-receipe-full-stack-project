...
const  AlertNotification = ({ show, text = "💙 Action Successful!" }) => {
  return (
      <AnimatePresence>
          {show && (
            <motion.div
